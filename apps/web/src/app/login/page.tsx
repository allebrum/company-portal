...
export default function LoginPage() {
  ...
  // Default to showing the password form until config loads (avoids a flash of "no methods").
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-gradient-to-br from-brand-900 via-brand-800 to-brand-700 p-6">
      <Card className="w-full max-w-sm p-6 space-y-5">
        ...
        {(error || oauthError) && <div className="text-sm text-red-600 text-center">{error ?? oauthError}</div>}
