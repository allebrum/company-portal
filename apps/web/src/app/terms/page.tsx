...
/**
 * Public Terms of Service page — fetches markdown from /policies/terms and
 * renders it through `marked`. The content is admin-authored (trusted), so
 * we don't hard-sanitize, but we keep raw HTML pass-through disabled and
 * defang `<script>` for paranoia.
 *
 * Twin of /privacy; the two share fetch + render logic but live as separate
 * routes so the URL is self-explanatory and links from the login page are
 * a one-line `<a href="/terms">`.
 */
export default function TermsPage() {
  return <PolicyPage kind="terms" title="Terms of Service" />;
}
